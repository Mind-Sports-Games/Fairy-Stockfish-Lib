...
static std::vector<std::string> variants = {"shogi", "xiangqi"};
...
TEST_CASE("Chess Threefold") {
  ...
  std::vector<std::string> moves{"b1c3", "g8f6", "c3b1", "f6g8",
                                 "b1c3", "g8f6", "c3b1", "f6g8"};
  auto position = fairystockfish::Position("chess", fen);
...
TEST_CASE("Shogi FourFold") {
  fairystockfish::init();
  std::vector<std::string> moves{"h2i2", "b8a8", "i2h2", "a8b8",
                                 "h2i2", "b8a8", "i2h2", "a8b8",
                                 "h2i2", "b8a8", "i2h2", "a8b8"};
...
TEST_CASE("Shogi checkmate FEN piecesInHand") {
  fairystockfish::init();
  std::string fen{"l2g1g1nl/5sk2/3p1p1p1/p3p1p1p/1n2n4/P4PP1P/1P1sPK1P1/5sR1+r/"
                  "L4+p1N1[GPSBBglpp] w - - 4 38"};
  auto position = fairystockfish::Position("shogi", fen);
...
TEST_CASE("Shogi Fools mate") {
  fairystockfish::init();
  std::string foolsFEN =
      "lnsg1gsnl/5rkb1/ppppppp+Pp/9/9/9/PPPPPPP1P/1B5R1/LNSGKGSNL[P] b - - 0 4";
...
TEST_CASE("Chess stalemate is a draw") {
  fairystockfish::init();
  std::string stalemateFEN =
      "5bnr/4p1pq/4Qpkr/7p/7P/4P3/PPPP1PP1/RNB1KBNR b KQ - 2 10";
  auto position = fairystockfish::Position("chess");
  std::vector<std::string> moves = {"e2e3", "a7a5", "d1h5", "a8a6", "h5a5",
                                    "h7h5", "a5c7", "a6h6", "h2h4", "f7f6",
...
TEST_CASE("Shogi stalemate is a win") {
  fairystockfish::init();
  std::string stalemateFEN =
      "8l/8k/9/8P/9/2P6/PP1PPPP2/1B5R1/LNSGKGSNL[] b - - 0 2";
...
TEST_CASE("Chess king only is insufficientMaterial") {
  fairystockfish::init();
  std::string insufficientMaterialFEN =
...
TEST_CASE("Shogi king only is not insufficientMaterial") {
  fairystockfish::init();
  std::string insufficientMaterialFEN =
      "8k/9/9/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL[LNSGGSNLBRPPPPPPPPP] b - - 0 2";
...
TEST_CASE(
    "Chess white king vs black king only should be insufficient material") {
  fairystockfish::init();
  ...
  // REQUIRE(fairystockfish::gameResult("chess", insufficientMaterialFEN, {}) ==
...
TEST_CASE("Chess autodraw") {
  ...
  std::vector<std::string> moves{
      ...
      "g7g6", "c1g5", "f8g7", "f2f4", "b8c6", "f1b5", "c8d7", "d4c6", "d7c6",
      "b5c6", "b7c6", "e1g1", "d8b6", "g1h1", "b6b2", "d1d3", "e8g8", "a1b1",
      "b2a3", "b1b3", "a3c5", "c3a4", "c5a5", "a4c3", "a8b8", "f4f5", "b8b3",
      "a2b3", "f6g4", "c3e2", "a5c5", "h2h3", "g4f2", "f1f2", "c5f2", "f5g6",
      "h7g6", "g5e7", "f8e8", "e7d6", "f2f1", "h1h2", "g7e5", "d6e5", "e8e5",
      "d3d8", "g8g7", "d8d4", "f7f6", "e2g3", "f1f4", "d4d7", "g7h6", "d7f7",
      "e5g5", "f7f8", "h6h7", "f8f7", "h7h8", "f7f8", "h8h7", "f8f7", "h7h6",
      "f7f8", "h6h7", "f8f7", "h7h8", "f7f8", "h8h7", "f8f7", "h7h6", "f7f8",
      "h6h7"};
  auto position = fairystockfish::Position("chess");
  position = position.makeMoves(moves);
  auto result = position.isOptionalGameEnd();
...
TEST_CASE("King of the hill variant win") {
  fairystockfish::init();
  std::vector<std::string> moves{"e2e4", "a7a6", "e1e2", "a6a5",
                                 "e2e3", "a5a4", "e3d4"};
...
TEST_CASE("Racing Kings Draw") {
  fairystockfish::init();
  std::vector<std::string> moves{"h2h3", "a2a3", "h3h4", "a3a4",
                                 "h4h5", "a4a5", "h5h6", "a5a6",
                                 "h6g7", "a6b7", "g7g8", "b7b8"};
...
TEST_CASE("Available Variants") {
  ...
  REQUIRE(std::find(variants.begin(), variants.end(), "shogi") !=
          variants.end());
  REQUIRE(std::find(variants.begin(), variants.end(), "xiangqi") !=
          variants.end());
  REQUIRE(std::find(variants.begin(), variants.end(), "my little pony") ==
          variants.end());
}
...
TEST_CASE("Shogi Unforced repetition is a draw") {
  ...
  std::vector<std::vector<std::string>> notDrawnSituations{
      {"c3c4", "a7a6", "b2g7+", "e9d8", "g7f6", "d8e9", "f6g7", "e9d8", "g7f6",
       "d8e9", "f6g7", "e9d8", "g7f6"},
      {"h2i2", "b8a8", "i2h2", "a8b8", "h2i2", "b8a8", "i2h2", "a8b8", "h2i2",
       "b8a8", "i2h2"},
  };
...
TEST_CASE("Shogi Forced checking repetition is a loss") {
  ...
  std::vector<std::vector<std::string>> notLossSituations{
      {
          "h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4",
          "d7e6", "g3g4", "c9c8", "c3c4", "c8d7", "b1c3", "g7g6",
          "g1f2", "f9g8", "d1d2", "g8g7", "f4e4", "e6f6", "e4f4",
          "f6e6", "f4e4", "e6f6", "e4f4", "f6e6",
      },
      {
          "h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4",
          "d7e6", "g3g4", "c9c8", "c3c4", "c8d7", "b1c3", "g7g6",
          "g1f2", "f9g8", "d1d2", "g8g7", "f4e4", "e6f6", "e4f4",
          "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4",
      },
  };
  ...
  std::vector<std::vector<std::string>> soonLostSituations{
      {"h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6",
       "g3g4", "c9c8", "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8",
       "d1d2", "g8g7", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6",
       "e4f4", "f6e6", "f4e4", "e6f6", "e4f4"},
  };
  ...
  std::vector<std::vector<std::string>> lossSituations2{
      {"c3c4", "e7e6", "b2g7+", "e9d8", "g7f6", "d8e9", "f6g7", "e9d8", "g7f6",
       "d8e9", "f6g7", "e9d8", "g7f6", "d8e9", "f6g7"},
      {"h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6",
       "g3g4", "c9c8", "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8",
       "d1d2", "g8g7", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6",
       "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4"},
  };
...
TEST_CASE("fairystockfish variant makeMoves v3") {
  ...
  SUBCASE("Must be able to make moves more than once from the same position") {
    ...
    {
      auto newPosition =
          shogiPos.makeMoves({"h2i2", "b8a8", "i2h2", "a8b8", "h2i2", "b8a8",
                              "i2h2", "a8b8", "h2i2", "b8a8", "i2h2", "a8b8"});
...
TEST_CASE("fairystockfish variant makeMoves individually") {
  ...
  SUBCASE("Must be able to make moves more than once from the same position") {
    fairystockfish::Position shogiPos("shogi");
    std::vector<std::string> moves = {
        "c3c4",  "e7e6",  "b2g7+", "e9d8", "g7f7", "e6e5", "e3e4",  "e5e4",
        "h2e2",  "e4e3+", "e2e3",  "P@e4", "e3e4", "h9g7", "P@e7",  "g7f5",
        "e7e8+", "d8c8",  "i3i4",  "b7b6", "h3h4", "b6b5", "h4h5",  "b5b4",
        "h5h6",  "a7a6",  "h6h7+", "a6a5", "h7h8", "b8b7", "e4e7+", "b7b6",
        "P@e4",  "c9b8",  "g3g4",  "b9a7", "d1e2", "c7c6", "e1d2",  "d7d6",
        "f7g8",  "b6b5",  "g8f9",  "b8b7", "i4i5", "i7i6"};
...
passOnStalemate = true
  ...
  std::vector<std::string> moves = {
      "P@d6", "P@c4", "P@f3", "P@f4", "P@e3", "P@e6", "P@c6", "P@f6", "P@c5",
      "P@c3", "P@d3", "P@f2", "P@f5", "P@d2", "P@b4", "P@a5", "P@b3", "P@d7",
      "P@a4", "P@a3", "P@c2", "P@b5", "P@e2", "P@d1", "P@g4", "P@h5", "P@h4",
      "P@h3", "P@e1", "P@f1", "P@g3", "P@h2", "P@b1", "P@b2", "P@a6", "P@a7",
      "P@b6", "P@b7", "P@c7", "P@g2", "P@a8", "P@c8", "P@a2", "d1d1", "P@a1",
      "d1d1", "P@b8", "d1d1", "P@c1", "d1d1", "P@d8", "P@e7", "P@e8", "P@f8",
      "P@g1", "P@f7", "P@h1", "e2e2", "P@g5", "P@g6",
...
TEST_CASE("5check game can continue after 3 checks") {
  ...
  std::vector<std::string> moves = {
      "e2e4", "c7c6", "d2d4", "d7d5", "e4d5", "c6c5", "d4c5", "c8g4",
      "f1b5", "g4d7", "b5d7", "d8d7", "c5c6", "b7c6", "d5c6", "d7d1",
      "e1d1", "b8c6", "b2b3", "e8c8", "c1d2", "d8d2",
  };
...
TEST_CASE(
  ...
  fairystockfish::Position pos1(
      "chess", "8/1Q2b1k1/2p3p1/p2p2P1/8/5PB1/PP3RK1/3r3q w - - 2 37", false);
  REQUIRE(pos1.gameResult() == -32000);

  // white wins
  fairystockfish::Position pos2(
      "chess", "2r3kr/p5Rp/1p3Qn1/4q3/8/2P5/P1P3PP/5R1K b - - 6 27", false);
  ...
  fairystockfish::Position pos4(
      "chess", "2r3kr/p4R1p/1p3Qn1/4q3/8/2P5/P1P3PP/5R1K w - - 5 27", false);
...
TEST_CASE("Convert to chess960") {
  ...
  // https://lichess.org/BdvgPSMd#82
  // from src/test/scala/chess/AutodrawTest.scala
  std::vector<std::string> moves{"e2e4", "c7c5", "g1f3", "d7d6", "d2d4", "c5d4",
                                 "f3d4", "g8f6", "b1c3", "g7g6", "c1g5", "f8g7",
                                 "f2f4", "b8c6", "f1b5", "c8d7", "d4c6", "d7c6",
                                 "b5c6", "b7c6", "e1g1"};
...
TEST_CASE("Convert to chess960 #2a") {
  fairystockfish::init();
  std::vector<std::string> moves{"e2e4", "b8c6", "b2b3", "e7e6", "c1b2",
                                 "d8h4", "b1c3", "h4e7", "d1f3", "c6d4",
                                 "f1b5", "d4f3", "g1f3", "a7a6", "e1g1"};
  std::vector<std::string> _960Moves =
      fairystockfish::to960Uci("5check", moves);
...
TEST_CASE("Convert to chess960 #3a (black)") {
  fairystockfish::init();
  std::vector<std::string> moves{
      "e2e4", "b7b6", "b1c3", "c8b7", "d2d4", "g7g6", "g1f3", "f8g7",
      "f3g5", "g8f6", "e4e5", "b8c6", "b2b3", "d7d6", "e5f6", "g7f6",
      "f1c4", "e7e6", "c3e4", "d8e7", "e4f6", "e7f6", "c4b5", "e8c8"};
  std::vector<std::string> _960Moves =
      fairystockfish::to960Uci("5check", moves);
...
TEST_CASE("Convert to chess960 #3b (black)") {
  ...
  std::vector<std::string> moves{
      "e2e4", "b7b6", "b1c3", "c8b7", "d2d4", "g7g6", "g1f3", "f8g7",
      "f3g5", "g8f6", "e4e5", "b8c6", "b2b3", "d7d6", "e5f6", "g7f6",
      "f1c4", "e7e6", "c3e4", "d8e7", "e4f6", "e7f6", "c4b5", "e8g8"};
  std::vector<std::string> _960Moves =
      fairystockfish::to960Uci("5check", moves);
...
TEST_CASE("Test valid rook moves don't get translated") {
  fairystockfish::init();
  std::vector<std::string> moves{
      "e2e4", "b8a6", "g1f3", "a6b8", "f1d3", "b8a6",
      "e1e2", "a6b8", "h1e1", "b8a6", "e1g1",
  };
  std::vector<std::string> _960Moves =
      fairystockfish::to960Uci("5check", moves);
...
TEST_CASE("Perft") {
  ...
  auto position = fairystockfish::Position("chess");
  std::function<unsigned int(fairystockfish::Position const &, unsigned int)>
      perft;

  perft = [&perft](fairystockfish::Position const &pos,
  ...
  if (debug)
    std::cout << "finished perft(2) @ " << std::ctime(&end_time)
              << "elapsed time: " << std::fixed << std::setprecision(18)
  ...
  if (debug)
    std::cout << "finished perft(4) @ " << std::ctime(&end_time)
  ...
  elapsed_seconds = end - start;
  if (debug)
    std::cout << "finished perft(5) @ " << std::ctime(&end_time)
              << "elapsed time: " << elapsed_seconds.count() << "s"
              << std::endl;
}
