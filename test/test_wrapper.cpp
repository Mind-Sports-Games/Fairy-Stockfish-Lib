...
TEST_CASE("Chess Threefold") {
    ...
    std::vector<std::string> moves{"b1c3", "g8f6", "c3b1", "f6g8", "b1c3", "g8f6", "c3b1", "f6g8"};
    auto position        = fairystockfish::Position("chess", fen);
...
TEST_CASE("Chess autodraw") {
    ...
    std::vector<std::string> moves{
        "e2e4", "c7c5", "g1f3", "d7d6", "d2d4", "c5d4", "f3d4", "g8f6", "b1c3", "g7g6", "c1g5",
        "f8g7", "f2f4", "b8c6", "f1b5", "c8d7", "d4c6", "d7c6", "b5c6", "b7c6", "e1g1", "d8b6",
        "g1h1", "b6b2", "d1d3", "e8g8", "a1b1", "b2a3", "b1b3", "a3c5", "c3a4", "c5a5", "a4c3",
        "a8b8", "f4f5", "b8b3", "a2b3", "f6g4", "c3e2", "a5c5", "h2h3", "g4f2", "f1f2", "c5f2",
        "f5g6", "h7g6", "g5e7", "f8e8", "e7d6", "f2f1", "h1h2", "g7e5", "d6e5", "e8e5", "d3d8",
        "g8g7", "d8d4", "f7f6", "e2g3", "f1f4", "d4d7", "g7h6", "d7f7", "e5g5", "f7f8", "h6h7",
        "f8f7", "h7h8", "f7f8", "h8h7", "f8f7", "h7h6", "f7f8", "h6h7", "f8f7", "h7h8", "f7f8",
        "h8h7", "f8f7", "h7h6", "f7f8", "h6h7"
    };
    auto position = fairystockfish::Position("chess");
    position      = position.makeMoves(moves);
    auto result   = position.isOptionalGameEnd();
...
TEST_CASE("Shogi Forced checking repetition is a loss") {
    ...
    std::vector<std::vector<std::string>> notLossSituations{
        {
            "h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6", "g3g4",
            "c9c8", "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8", "d1d2", "g8g7",
            "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6",
        },
        {
            "h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6", "g3g4",
            "c9c8", "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8", "d1d2", "g8g7",
            "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4",
        },
    };
    ...
    std::vector<std::vector<std::string>> soonLostSituations{
        {"h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6", "g3g4", "c9c8",
         "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8", "d1d2", "g8g7", "f4e4", "e6f6",
         "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6", "e4f4"},
    };
    ...
    std::vector<std::vector<std::string>> lossSituations{
        {
            "h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6", "g3g4", "c9c8",
            "c3c4", "c8d7", "b1c3", "g7g6", "g1f2", "f9g8", "d1d2", "g8g7", "f4e4", "e6f6",
            "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6",
        },
    };
    ...
    std::vector<std::vector<std::string>> lossSituations2{
        ...
        {"h3h4", "e9d8", "h4h5", "d7d6", "h2h4", "d8d7", "h4f4", "d7e6", "g3g4", "c9c8", "c3c4",
         "c8d7", "b1c3", "g7g6", "g1f2", "f9g8", "d1d2", "g8g7", "f4e4", "e6f6", "e4f4", "f6e6",
         "f4e4", "e6f6", "e4f4", "f6e6", "f4e4", "e6f6", "e4f4", "f6e6", "f4e4"},
    };
...
TEST_CASE("fairystockfish variant makeMoves individually") {
    ...
    SUBCASE("Must be able to make moves more than once from the same position") {
        fairystockfish::Position shogiPos("shogi");
        std::vector<std::string> moves
            = {"c3c4",  "e7e6", "b2g7+", "e9d8", "g7f7", "e6e5", "e3e4",  "e5e4", "h2e2", "e4e3+",
               "e2e3",  "P@e4", "e3e4",  "h9g7", "P@e7", "g7f5", "e7e8+", "d8c8", "i3i4", "b7b6",
               "h3h4",  "b6b5", "h4h5",  "b5b4", "h5h6", "a7a6", "h6h7+", "a6a5", "h7h8", "b8b7",
               "e4e7+", "b7b6", "P@e4",  "c9b8", "g3g4", "b9a7", "d1e2",  "c7c6", "e1d2", "d7d6",
...
TEST_CASE(
    ...
    REQUIRE(pos1.gameResult() == -32'000);

    // white wins
    fairystockfish::Position pos2(
        "chess", "2r3kr/p5Rp/1p3Qn1/4q3/8/2P5/P1P3PP/5R1K b - - 6 27", false
    );
    REQUIRE(pos2.gameResult() == -32'000);

    // stalemate
    fairystockfish::Position pos3(
        "chess", "rn2k1nr/pp4pp/3p4/q1pP4/P1P2p1b/1b2pPRP/1P1NP1PQ/2B1KBNR w Kkq - 0 13", false
    );
...
TEST_CASE("Convert to chess960") {
    ...
    // https://lichess.org/BdvgPSMd#82
    // from src/test/scala/chess/AutodrawTest.scala
    std::vector<std::string> moves{"e2e4", "c7c5", "g1f3", "d7d6", "d2d4", "c5d4", "f3d4",
...
TEST_CASE("Convert to chess960 #3a (black)") {
    fairystockfish::init();
    std::vector<std::string> moves{"e2e4", "b7b6", "b1c3", "c8b7", "d2d4", "g7g6", "g1f3", "f8g7",
...
TEST_CASE("Perft") {
    ...
    REQUIRE(perft(position, 4) == 197'281);
    ...
    start = std::chrono::system_clock::now();
    REQUIRE(perft(position, 5) == 4'865'609);
    end = std::chrono::system_clock::now();
